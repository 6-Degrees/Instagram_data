    ...
    def collect_followers(self, cookie, name, user_id, end_cursor=None):
        ...
        if next_page:
            if data['status'] != 'fail':
                self.count2 += 1
                print(self.count2)
                rand1 = random.randrange(8,16)
                rand2 = random.randrange(80,160)
                if (self.count2 % rand1 == 0) and self.count2 >= 100 :
                    delay1 = random.randrange(1,5)
                    print('sleeping...%s' % delay1)
                    time.sleep(delay1)
                if (self.count2 % rand2 == 0):
                    delay2 = random.randrange(10,25)
                    print('sleeping...%s' % delay2)
                    time.sleep(delay2)
    ...
    def collect_follows(self, cookie, name, user_id, end_cursor=None):
        ...
        if next_page:
            if data['status'] != 'fail':
                ...
                rand1 = random.randrange(8,16)
                rand2 = random.randrange(80,160)
                if (self.count1 % rand1 == 0) and self.count1 >= 100 :
                    delay1 = random.randrange(1,5)
                    print('sleeping...%s' % delay1)
                    time.sleep(delay1)
                if (self.count1 % rand2 == 0):
                    delay2 = random.randrange(10,25)
                    print('sleeping...%s' % delay2)
                    time.sleep(delay2)
                self.collect_followers(cookie, name, user_id, next_end_cursor)
